<template><div><h1 id="springcloud" tabindex="-1"><a class="header-anchor" href="#springcloud" aria-hidden="true">#</a> SpringCloud</h1>
<h2 id="什么是服务熔断-什么是服务降级" tabindex="-1"><a class="header-anchor" href="#什么是服务熔断-什么是服务降级" aria-hidden="true">#</a> 什么是服务熔断?什么是服务降级?</h2>
<p>触发原因不一样，服务熔断由链路上某个服务引起的，服务降级是从整体的负载考虑管理目标层次不一样，服务熔断是一个框架层次的处理，服务降级是业务层次的处理
...
<h2 id="cap" tabindex="-1"><a class="header-anchor" href="#cap" aria-hidden="true">#</a> CAP</h2>
...
<ul>
<li>Zookeeper: CP(C:一致性，P:分区容错性)</li>
<li>Eureka: AP(A:高可用)</li>
<li>Nacos: CP/AP</li>
</ul>
</div></template>
